    ...
    <div className="min-h-screen bg-navy flex items-center justify-center p-8">
      ...
      >
        <div className="mb-12 text-center">
          ...
          <h2 className="text-white text-3xl font-bold">Welcome to Clemtrix Technologies</h2>
          <p className="text-white/60">Let's get your business set up in seconds.</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="grid grid-cols-2 gap-6">
              <div className="space-y-6">
                <h3 className="font-bold text-lg text-navy border-b pb-2">Business Profile</h3>
                <Input 
                  label="Business Name" 
              ...
              <div className="space-y-6">
                <h3 className="font-bold text-lg text-navy border-b pb-2">Owner Profile</h3>
                <Input 
                  label="Full Name" 
