      ...
      const res = await fetch('/api/products', {
        ...
        body: JSON.stringify({
          ...
          initialBatch: {
            ...form.initialBatch,
            quantity:
              parseInt(form.initialBatch.quantity || '0') || 0,
          },
        }),
      });
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 font-medium italic text-sm">
            Manage your business inventory and stock batches.
          </p>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-100">
                ...
                <th className="px-8 py-4 text-xs font-black text-gray-400 uppercase tracking-widest text-center">
                  In Stock
                </th>

                <th className="px-8 py-4 text-xs font-black text-gray-400 uppercase tracking-widest text-right">
                  Selling Price
                </th>
                ...
                <tr>
                  ...
                  >
                    ...
                    <p className="text-gray-400 italic text-lg">
                      Your inventory is empty. Start adding your
                      first product.
                    </p>
                  </td>
                </tr>
        ...
        {isAddModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-8">
            ...
            >
              <div className="p-8 border-b flex justify-between items-center bg-gray-50/50">
                <div>
                  ...
                  <p className="text-gray-500 text-sm font-medium">
                    Create a new product and stock batch.
                  </p>
                </div>
              ...
              <div className="flex-1 p-8 grid grid-cols-1 md:grid-cols-2 gap-10 overflow-y-auto">
                <div className="space-y-6">
                  <Input
                    label="Product Name"
                    required
